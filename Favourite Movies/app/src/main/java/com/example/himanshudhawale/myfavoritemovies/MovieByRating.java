...
public class MovieByRating extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() !=null && getIntent().getExtras() !=null) {
            ...
            list = getIntent().getExtras().getParcelableArrayList(MainActivity.BYRATING);
            final int j = list.size();

            Collections.sort(list, new Comparator<Movies>() {
                public int compare(Movies o1, Movies o2) {
                    return Integer.compare(o2.movieRating, o1.movieRating);
                }
            ...
            ivFirst.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(i==0)
                    {
                        Toast.makeText(MovieByRating.this, "This is the first movie", Toast.LENGTH_SHORT).show();
                    }
            ...
            ivNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(i==j-1)
                    {
                        Toast.makeText(MovieByRating.this, "This is the last movie", Toast.LENGTH_SHORT).show();
                    }
